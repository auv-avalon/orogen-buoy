...
#ifndef BUOY_DETECTOR2_TASK_HPP
#define BUOY_DETECTOR2_TASK_HPP

#include "opencv/cv.h"
#include "buoy/Detector2Base.hpp"
...
namespace buoy {
     ...
     */
    class Detector2 : public Detector2Base
    {
	friend class Detector2Base;
    protected:
    ...
    public:
         ...
         */
        Detector2(std::string const& name = "buoy::Detector", TaskCore::TaskState initial_state = Stopped);
         ...
         * \param initial_state The initial TaskState of the TaskContext. Default is Stopped state.
         */
        Detector2(std::string const& name, RTT::ExecutionEngine* engine, TaskCore::TaskState initial_state = Stopped);
