...
Detector2::Detector2(std::string const& name, TaskCore::TaskState initial_state)
    : Detector2Base(name, initial_state)
{
...
Detector2::Detector2(std::string const& name, RTT::ExecutionEngine* engine, TaskCore::TaskState initial_state)
    : Detector2Base(name, engine, initial_state)
{
//	h_frame = new base::samples::frame::Frame();
//	s_frame = new base::samples::frame::Frame();
}
...
bool Detector2::configureHook()
{
//    std::cout <<"configure" << std::endl;
     if (! Detector2Base::configureHook())
         return false;
     return true;
}
bool Detector2::startHook()
{
//    std::cout <<"start" << std::endl;
    if (!Detector2Base::startHook()){
...
void Detector2::cleanupHook() {
	Detector2Base::cleanupHook();
}
