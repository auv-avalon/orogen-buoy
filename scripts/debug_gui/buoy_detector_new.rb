...
#  def initialize()
    ...
    @buoy_task.binary_image.connect_to @window.image_binary, :type=>:buffer,:size=>1
    @buoy_task.grayscale_image.connect_to @window.image_grayscale, :type=>:buffer,:size=>1
    @buoy_task.debug_image.connect_to @window.image_debug, :type=>:buffer,:size=>1
